...
```
/Users/tanshow/Downloads/bss-certify-v2/
├── SKILL.md                              [主技能文档 - 全面升级]
...
**v2.0 触发条件**:
```yaml
description: BSS-Certify v2.0 - Next Generation Skill Security Certification. 对 Agent Skills 进行多维度深度安全分析...输出结构化安全报告，包含评级内容、敏感风险点、外部API清单...
```
...
### 问题反馈
- GitHub Issues: [bss-certify/issues](https://github.com/...)
- 邮件: bss-certify@example.com
...
**升级到 BSS-Certify v2.0，让 Skill 安全检测进入 next level! 🚀**
